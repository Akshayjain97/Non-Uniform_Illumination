...
if  __name__ == "__main__":
    ...
    net = torchvision.models.mobilenet_v3_small(); net1 = 'mobilenet_v3_small'
    ...
    load_model(torch.load("/sda/akshay/NUI/Results/CIFAR10_B256_LR001_mobilenet_v3_small_Adam.t7"))
